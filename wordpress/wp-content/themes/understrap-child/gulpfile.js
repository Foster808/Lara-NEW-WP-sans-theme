...
gulp.task( 'scripts', function() {
    var scripts = [
		...
		`${paths.dev}/js/vendor/headroom.js`,
		`${paths.dev}/js/vendor/jquery.scrollTo.js`,
        ...
        `${paths.dev}/js/child-custom-javascript.js`,
    ];
...
// parent theme js files /src/js
    gulp.src( `${paths.node}understrap/src/js/**/*.js` )
...
// UnderStrap SCSS files
    gulp.src( `${paths.node}understrap/fonts/*` )
...
// Fontawesome SCSS files
    gulp.src( `${paths.node}understrap/src/sass/fontawesome/*.scss` )
        .pipe( gulp.dest( `${paths.dev}/sass/fontawesome` ) );
